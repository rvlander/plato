...
/// collatinus_lookup() handles initialization via std::call_once and is thread-safe,
/// so this just gives it a head start. If lookup() is called before this finishes,
/// it will block briefly inside the C++ call_once until init completes.
